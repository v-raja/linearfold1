...
func main() {
	...
	LinearFold("AAAACGGUCCUUAUCAGGACCAAACA")
	LinearFold("AUUCUUGCUUCAACAGUGUUUGAACGGAAU")
	LinearFold("UCGGCCACAAACACACAAUCUACUGUUGGUCGA")
	LinearFold("GUUUUUAUCUUACACACGCUUGUGUAAGAUAGUUA")

	// Need to change beam_size to 20 if you want to run these examples
	// LinearFold("GGGCUCGUAGAUCAGCGGUAGAUCGCUUCCUUCGCAAGGAAGCCCUGGGUUCAAAUCCCAGCGAGUCCACCA")
